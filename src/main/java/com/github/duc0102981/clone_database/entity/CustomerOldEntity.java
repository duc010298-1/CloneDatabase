package com.github.duc0102981.clone_database.entity;
...
@Entity
@Table(name = "customer", schema = "public", catalog = "")
public class CustomerOldEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        CustomerOldEntity that = (CustomerOldEntity) o;
        return id == that.id &&
